...
### Nivel 2. Raíz `CLAUDE.md` y `CODEX.md`
...
### Nivel 4. Subcarpetas con `AGENTS.md`, `CLAUDE.md` o `CODEX.md`
...
### Para `CLAUDE.md` y `CODEX.md` raíz
...
7. Si `CLAUDE.md` o `CODEX.md` raíz duplican contenido de `AGENTS.md`, proponer reducirlos a archivos puente.
...
- No duplicar en `CLAUDE.md` o `CODEX.md` raíz lo que pertenece a `AGENTS.md` raíz.
...
**6. Propuesta de reorganización documental, si aplica.** Explica cómo mover o consolidar contenido entre `AGENTS.md`, `CLAUDE.md`, `CODEX.md`, `contexto_proyecto.md`, archivos de subcarpeta y archivos `*.override`.
...
- duplicación de contenido entre `AGENTS.md`, `CLAUDE.md` y `CODEX.md`
